...
if __name__ == "__main__":
    ...
    grape_weather_path = project_root / "data" / "daily_weather_clean_table_grapes.csv"
    grape_training = project_root / "data" / "table_grape_training.csv"


    df = pd.read_csv(grape_weather_path)
    df["date"] = pd.to_datetime(df["date"])
    season_start_date = "2024-04-01"
    as_of_date1 = "2024-05-15"
    actual_days1, actual_harvest_date1 = load_actual_harvest(grape_training, as_of_date1)
    as_of_date2 = "2024-06-15"
    actual_days2, actual_harvest_date2 = load_actual_harvest(grape_training, as_of_date2)
    as_of_date3 = "2024-07-15"
    actual_days3, actual_harvest_date3 = load_actual_harvest(grape_training, as_of_date3)
    ...
    print("Prediction test [table grapes]:")
    print(print_demo_result("Table Grapes Demo 1", result1, actual_days1, actual_harvest_date1))
    print(print_demo_result("Table Grapes Demo 2", result2, actual_days2, actual_harvest_date2))
    print(print_demo_result("Table Grapes Demo 3", result3, actual_days3, actual_harvest_date3))
