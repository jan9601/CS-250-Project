...
def main():
    ...
    in_path = project_root / "data" / "daily_weather_table_grapes.csv"
    out_path = project_root / "data" / "daily_weather_clean_table_grapes.csv"
    ...
    print("Missing days:", len(full_range) - len(df))
