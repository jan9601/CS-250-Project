...
def main():
    ...
    weather_path = project_root / "data" / "weather_with_gdd_table_grapes.csv"
    seasons_path = project_root / "data" / "table_grape_seasons.csv"
    out_path = project_root / "data" / "table_grape_training.csv"
